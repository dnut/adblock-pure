  ...
  var recordMessageWithUserID = function(msg, queryType, callback) {
    ...
    var fullUrl = 'https://github.com/dnut/adblock-pure/' +
  ...
  var installedURL = "https://github.com/dnut/adblock-pure/" + STATS.userId;
  ...
  /* This has been disabled to protect user privacy and prevent irritation.
  ...
  if (!SAFARI && chrome.runtime.id === "pljaalgmajnlogcgiohkhdmgpomjcihk") {
      ...
      chrome.runtime.onInstalled.addListener(function(details) {
          if (details.reason === "update" || details.reason === "install") {
              openTab("https://github.com/dnut/adblock-pure/");
